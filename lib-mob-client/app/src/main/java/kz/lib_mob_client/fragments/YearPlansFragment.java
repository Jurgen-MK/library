...
public class YearPlansFragment extends Fragment {

    TokenManager tokenManager;
    List<TechnicalLessonYearPlan> listTlyp;
    RecyclerView rvRespond;

    public YearPlansFragment() {
        // Required empty public constructor
    }


    public static YearPlansFragment newInstance() {
        YearPlansFragment fragment = new YearPlansFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_year_plans, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        listTlyp = new ArrayList<>();
        try {
            listTlyp = ServiceAuth.createService(ServiceApi.class, tokenManager).getAllTechnicalLessonYearPlans().execute().body();
            RecyclerView.LayoutManager manager = new LinearLayoutManager(getContext());
            List<IFlexible> list = new ArrayList<>();
            list.addAll(listTlyp);
